...
<body>
	...
	<br>
	<h2 style="text-align: center">코로나 선별진료소</h2>
	<br>
	<center>
	<form method="post" action="search.cov">
	...
	<br>
		<table class="table">
			...
			<c:forEach items="${list}" var="row">
				<tr>
					<td align=center bgcolor=pink>&nbsp;<font size=2>${row.hospital}</td>
					<td align=center bgcolor=pink>&nbsp;<font size=2>${row.addr}</td>
